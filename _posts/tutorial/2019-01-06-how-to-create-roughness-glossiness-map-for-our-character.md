...
<img src="/images/01_head_sculpt.jpg" alt="01_head_sculpt" class="narrowResponsive">
...
<img src="/images/02_baking_layers.jpg" alt="02_baking_layers" class="narrowResponsive">

Then, fill your model with white color.

<img src="/images/03_fill_color.jpg" alt="03_fill_color" class="narrowResponsive">
...
<img src="/images/04_mask_by_cavity.jpg" alt="04_mask_by_cavity" class="narrowResponsive">
...
<img src="/images/05_head_masked.jpg" alt="05_head_masked" class="narrowResponsive">
...
<img src="/images/06_cavity_map.jpg" alt="06_cavity_map" class="narrowResponsive">
...
<img src="/images/07_creating_texture.jpg" alt="07_creating_texture" class="narrowResponsive">

Then, you need to clone your texture to be able to export it. Click on _Clone Txtr_ to clone it.

<img src="/images/08_cloning_texture.jpg" alt="08_cloning_texture" class="narrowResponsive">
...
<img src="/images/09_exporting_texture.jpg" alt="09_exporting_texture" class="narrowResponsive">
...
<img src="/images/10_subdivision_level.jpg" alt="10_subdivision_level" class="narrowResponsive">

So, After putting the SDiv level of your model to half, click on _Create DispMap_ under the _Displacement Map_ menu.

<img src="/images/11_creating_disp_map.jpg" alt="11_creating_disp_map" class="narrowResponsive">
...
<img src="/images/12_exporting_disp_map.jpg" alt="12_exporting_disp_map" class="narrowResponsive">
...
<img src="/images/13_photoshop_composite.jpg" alt="images/13_photoshop_composite" class="narrowResponsive">
...
<img src="/images/14_photoshop_adjustment_layer.jpg" alt="14_photoshop_adjustment_layer" class="narrowResponsive">
...
<img src="/images/15_glossiness_map.jpg" alt="15_glossiness_map" class="narrowResponsive">
...
<img src="/images/16_roughness_map.jpg" alt="16_roughness_map" class="narrowResponsive">

Here’s the final real-time render I got in _Marmoset Toolbag 3.04_.

<img src="/images/17_head_final_render.jpg" alt="17_head_final_render" class="narrowResponsive">
